...
const FALLBACK: Suggestion[] = [
  ...
  { id: 'Q08', label: '营销费用占比最高的渠道', domain: '经营财务', chart_hint: 'pie', icon: '💰' },
  { id: 'Q09', label: '毛利率最高的是哪个车型', domain: '经营财务', chart_hint: 'bar', icon: '💰' },
  ...
  { id: 'Q13', label: '各门店客流成交转化率排名', domain: '渠道经营', chart_hint: 'bar', icon: '🏪' },
  { id: 'Q14', label: '客流漏斗：进店→留资→试驾→成交', domain: '渠道经营', chart_hint: 'funnel', icon: '🏪' },
  { id: 'Q15', label: '转化率低于10%的门店', domain: '渠道经营', chart_hint: 'table', icon: '🏪' },
];
