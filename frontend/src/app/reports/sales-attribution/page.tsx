...
// 销量归因分析报表
// 复用驾驶舱 SnapshotBoard；未来叠加 SOP 四步归因引擎输出。
...
export default function SalesAttributionReportPage() {
  return (
    <>
          ...
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div className="flex-1 min-w-[240px]">
              <div className="flex items-center gap-2 mb-1">
                ...
                <h2 className="text-base font-semibold text-gac-gray-900">销量归因分析</h2>
              ...
              <p className="text-sm text-gac-gray-500 leading-relaxed">
                通过 SOP 四步归因引擎，定位销量波动的根因（渠道 / 大区 / 价格 / 产品）。
                下方视图为复用驾驶舱核心指标，归因维度后续叠加。
              </p>
            </div>
      ...
      <SnapshotBoard
        title="销量归因分析 · 驾驶舱视图"
        subtitle="Sprint 7 实现 · SOP 归因输出后续叠加"
      />
    </>
  );
}
